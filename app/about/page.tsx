          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600 text-center text-sm">{t('team_member1_desc')}</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600 text-center text-sm">{t('team_member2_desc')}</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600 text-center text-sm">{t('team_member3_desc')}</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-gray-600 text-center text-sm">{t('team_member4_desc')}</p>
              </div>
            </div>
          </div>
        </div>
