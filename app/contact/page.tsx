      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="md:col-span-1">
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-semibold mb-4">{t('get_in_touch')}</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-gray-900">{t('email_label')}</h3>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-gray-900">{t('support_hours_label')}</h3>
                  <p className="text-sm text-gray-600">{t('support_hours_value')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-gray-900">{t('faq_label')}</h3>
                  <p className="text-sm text-gray-600">
                    {t('faq_desc_1')} <Link href="/faq" className="text-primary-600 hover:text-primary-800">{t('faq_desc_2')}</Link> {t('faq_desc_3')}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              <h3 className="text-sm font-medium text-gray-900 mb-3">{t('follow_us')}</h3>
        ...
        <div className="md:col-span-2">
          {isSubmitted ? (
            ...
            >
              ...
              <h2 className="text-xl font-semibold text-green-800 mb-2">{t('success_title')}</h2>
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  ...
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">
                      {t('email_form_label')} <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="email"
                      id="email"
                ...
                <div className="flex items-center">
                  ...
                  >
                    {isSubmitting ? t('submitting') : t('send_message')}
                  </button>
