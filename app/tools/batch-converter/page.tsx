  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-12">
        <h1 className="text-3xl font-extrabold text-surface-900 sm:text-4xl">
          Batch File Converter
        </h1>
        <p className="mt-3 max-w-2xl mx-auto text-xl text-surface-500 sm:mt-4">
          Convert multiple files at once. Fast, secure, and free.
        </p>
      </div>

      <div className="mb-16">
        <div className="bg-white overflow-hidden shadow-sm rounded-lg divide-y divide-surface-200">
          <div className="px-4 py-5 sm:px-6">
            <h2 className="text-lg font-medium text-surface-800">Upload your files</h2>
          ...
          <div className="px-4 py-5 sm:p-6" id="upload">
            ...
            <div className="text-center py-12 bg-surface-50 rounded-lg border-2 border-dashed border-surface-300">
      ...
      <div className="mb-16">
        <h2 className="text-2xl font-bold text-surface-800 mb-6">How to Convert Multiple Files at Once</h2>
        <div className="grid md:grid-cols-4 gap-8">
          <div className="bg-white overflow-hidden shadow-sm rounded-lg">
            <div className="px-4 py-5 sm:p-6 text-center">
              <div className="text-4xl text-primary-600 mb-4">1</div>
              <h3 className="text-lg font-medium text-surface-800 mb-2">Upload your files</h3>
          ...
          <div className="bg-white overflow-hidden shadow-sm rounded-lg">
            <div className="px-4 py-5 sm:p-6 text-center">
              <div className="text-4xl text-primary-600 mb-4">2</div>
              <h3 className="text-lg font-medium text-surface-800 mb-2">Select output format</h3>
              <p className="text-sm text-surface-500">
          ...
          <div className="bg-white overflow-hidden shadow-sm rounded-lg">
            <div className="px-4 py-5 sm:p-6 text-center">
              <div className="text-4xl text-primary-600 mb-4">3</div>
              <h3 className="text-lg font-medium text-surface-800 mb-2">Start batch conversion</h3>
              <p className="text-sm text-surface-500">
          ...
          <div className="bg-white overflow-hidden shadow-sm rounded-lg">
            <div className="px-4 py-5 sm:p-6 text-center">
              <div className="text-4xl text-primary-600 mb-4">4</div>
              <h3 className="text-lg font-medium text-surface-800 mb-2">Download files</h3>
              <p className="text-sm text-surface-500">
      ...
      <div className="mb-16">
        <h2 className="text-2xl font-bold text-surface-800 mb-6">Benefits of Batch Conversion</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white overflow-hidden shadow-sm rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg font-medium text-surface-800 mb-2">Save Time</h3>
          ...
          <div className="bg-white overflow-hidden shadow-sm rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg font-medium text-surface-800 mb-2">Consistent Results</h3>
              <p className="text-surface-600">
          ...
          <div className="bg-white overflow-hidden shadow-sm rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <h3 className="text-lg font-medium text-surface-800 mb-2">Simplified Workflow</h3>
              <p className="text-surface-600">
      ...
      <div className="mb-16">
        <h2 className="text-2xl font-bold text-surface-800 mb-6">Frequently Asked Questions</h2>
        <div className="bg-white overflow-hidden shadow-sm rounded-lg divide-y divide-surface-200">
          <div className="px-4 py-5 sm:p-6">
            <h3 className="text-lg font-medium text-surface-800 mb-2">How many files can I convert at once?</h3>
            <p className="text-surface-600">
          ...
          <div className="px-4 py-5 sm:p-6">
            <h3 className="text-lg font-medium text-surface-800 mb-2">What file formats are supported for batch conversion?</h3>
            <p className="text-surface-600">
          ...
          <div className="px-4 py-5 sm:p-6">
            <h3 className="text-lg font-medium text-surface-800 mb-2">Is batch conversion free?</h3>
            <p className="text-surface-600">
          ...
          <div className="px-4 py-5 sm:p-6">
            <h3 className="text-lg font-medium text-surface-800 mb-2">How long does batch conversion take?</h3>
            <p className="text-surface-600">
          ...
          <div className="px-4 py-5 sm:p-6">
            <h3 className="text-lg font-medium text-surface-800 mb-2">Is my data safe during batch conversion?</h3>
            <p className="text-surface-600">
      ...
      <div className="bg-surface-100 rounded-lg p-6">
        <h2 className="text-xl font-bold text-surface-800 mb-4">Need to convert more files?</h2>
        ...
        <a
          href="/pricing"
          className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-surface-900 hover:bg-surface-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-surface-500"
        >
          View Premium Plans
        </a>
      </div>
