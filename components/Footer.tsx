      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary-400 to-primary-300">
              ConvertViral
            </h3>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://youtube.com/convertviral" target="_blank" rel="noopener noreferrer" className="text-surface-400 hover:text-primary-400 transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <form onSubmit={handleSubscribe} className="space-y-2">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 rounded-lg bg-surface-800 border border-surface-700 text-white placeholder-surface-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  required
                />
                <button
                  type="submit"
        ...
        <div className="pt-8 mt-8 border-t border-surface-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-surface-500 text-sm mb-4 md:mb-0">
            © {currentYear} ConvertViral. All rights reserved.
          </p>
          <div className="flex flex-wrap justify-center space-x-4 text-sm text-surface-500">
            <Link href="/privacy" className="hover:text-primary-400 transition-colors mb-2 md:mb-0">
              Privacy Policy
            </Link>
            <Link href="/terms" className="hover:text-primary-400 transition-colors mb-2 md:mb-0">
              Terms of Service
            </Link>
            <Link href="/cookies" className="hover:text-primary-400 transition-colors mb-2 md:mb-0">
              Cookie Policy
            </Link>
            <Link href="/impressum" className="hover:text-primary-400 transition-colors mb-2 md:mb-0">
              Impressum
            </Link>
            <Link href="/sitemap" className="hover:text-primary-400 transition-colors mb-2 md:mb-0">
              Sitemap
            </Link>
          </div>
        </div>
