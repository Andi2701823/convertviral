  ...
  const pricingPlans: PricingPlan[] = [
    {
      ...
      cta: "Current Plan",
      ctaStyle: "bg-surface-200 text-surface-500 cursor-not-allowed",
      popular: false,
      stripeLink: null
    },
    {
      ...
      ctaStyle: "bg-surface-900 text-white hover:bg-surface-700",
      popular: true,
    ...
    <section className="py-20 bg-surface-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 text-surface-900">
          ...
          <div className="inline-flex bg-surface-200 rounded-lg p-1">
            ...
            >
              Yearly
              <span className="ml-1 bg-accent-100 text-accent-600 px-2 py-0.5 rounded-full text-xs">
                Save 20%
              </span>
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {pricingPlans.map((plan, index) => (
            <div
              key={index}
              className={`
                relative bg-white rounded-2xl shadow-sm p-8 transition-all duration-300
                ${plan.popular
                  ? 'border-2 border-primary-500 scale-105 shadow-lg'
                  : 'border border-surface-200 hover:shadow-md'
                }
              `}
            >
              {plan.popular && (
              ...
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold mb-2 text-surface-800">{plan.name}</h3>
