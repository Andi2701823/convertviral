        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, worker_1.runMaintenance)()];
                case 1:
                    // Run worker maintenance
                    _a.sent();
                    // Clean up expired CDN files
                    return [4 /*yield*/, (0, cdn_1.cleanupExpiredCDNFiles)()];
                case 2:
                    // Clean up expired CDN files
                    _a.sent();
                    // Update sitemaps
                    console.log('Updating sitemaps...');
                    return [4 /*yield*/, execAsync('ts-node scripts/update-sitemaps.ts')];
                case 3:
                    _a.sent();
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('Error running maintenance tasks:', error_1);
                    return [3 /*break*/, 7];
                case 5: 
